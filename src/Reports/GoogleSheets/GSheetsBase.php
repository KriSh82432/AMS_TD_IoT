...
class AMS
{
    ...
    public function CreateNewTab(string $tabName)
    {
        ...
        $response = $this->service->spreadsheets->batchUpdate($this->sheetId, $requestBody);
        return $response;
    }

    public function AppendRow(string $sheetName, array $data)
    {
        ...
        $response = $this->service->spreadsheets_values->append($this->sheetId, $sheetName, $valueRange, $options);
        return $response;
    }
